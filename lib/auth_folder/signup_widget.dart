        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: const Text("S'inscrire", style: TextStyle(fontSize: 24)),
            ),
            const SizedBox(height: 20),
            // Row(
            //   children: [
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    recognizer:
                        TapGestureRecognizer()..onTap = widget.onClickedSignIn,
                    text: "Se connecter",
                    style: TextStyle(
                      decoration: TextDecoration.underline,
...
Widget ftkLogo(size) {
  String imagePath = 'assets/images/onBoard6.jpg';
  return Image.asset(imagePath, height: size, width: size);
}
